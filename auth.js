...
var OAUTH2_CLIENT_ID = '1030024881954-6on4h6ne7nmnobcemu98je94pqgdsbur.apps.googleusercontent.com';
var OAUTH2_SCOPES = [
...
var apiKey = 'AIzaSyCU-2ipMbHchF2riglPoPXYj6U_RkF3QzY';
...
function getEmailCallback(obj){
    ...
    $('#login-link').html($('#login-link').html().replace(re, obj.result.name));
